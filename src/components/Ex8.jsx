...
export default function Ex8() {
  ...
  return (
    ...
    <section className="flex justify-center items-center mb-12">
      <div className="bg-white p-6 rounded-lg shadow-md w-64 text-center hover:-translate-y-1 hover:shadow-xl">
        <div className="text-4xl text-blue-600 mb-4 flex justify-center hover:animate-bounce">
          <FaShoppingCart />
        </div>
